...
{
    [DataContract]
    [Obsolete("FontDefinition Class should be used instead of this. This class must continue to exist for deserialization purposes.", false)]
    public class Old_FontDefinition : INotifyPropertyChanged
    {
